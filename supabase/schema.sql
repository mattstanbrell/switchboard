...
CREATE OR REPLACE FUNCTION "public"."process_inbound_email"("customer_id" "uuid", "target_company_id" "uuid", "from_email" "text", "subject" "text" DEFAULT NULL::"text", "text_content" "text" DEFAULT NULL::"text", "html_content" "text" DEFAULT NULL::"text", "focus_area" "text" DEFAULT NULL::"text") RETURNS "json"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
DECLARE
